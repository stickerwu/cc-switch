> **UOS 20 compatibility branch**: CC Switch 3.20.3 for amd64, using Tauri 1 / WebKitGTK 4.0. See [UOS-BUILD.md](UOS-BUILD.md) for building, installation, limitations and backup/rollback guidance. Do not install upstream generic Linux updates over this build.
