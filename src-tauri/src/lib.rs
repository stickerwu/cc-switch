...
mod tests {
    use super::{
        enabled_proxy_apps_on_startup, redact_url_for_log,
    ...
    // Tauri 1 has no exit-code-bearing RunEvent; v2 restart classification tests do not apply.
